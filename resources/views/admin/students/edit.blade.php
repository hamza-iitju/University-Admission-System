...
@section('content')
    ...
    {!! Form::model($student, ['method' => 'PUT', 'route' => ['admin.students.update', $student->id], 'files' => true,]) !!}
        ...
        <div class="panel-body">
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    ...
                    {!! Form::text('ssc_gpa', old('ssc_gpa'), ['class' => 'form-control', 'placeholder' => '']) !!}
                    <p class="help-block"></p>
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    ...
                    {!! Form::text('hsc_diploma_gpa', old('hsc_diploma_gpa'), ['class' => 'form-control', 'placeholder' => '']) !!}
                    <p class="help-block"></p>
