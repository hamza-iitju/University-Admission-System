...
TableTools.prototype = {
	...
	"_fnCollectionShow": function ( nButton, oConfig )
	{
		 ...
		 */
		setTimeout( function () {
			$(nHidden).animate({"opaacademic": 1}, 500);
			$(nBackground).animate({"opaacademic": 0.25}, 500);
		}, 10 );
	...
	"_fnCollectionHide": function ( nButton, oConfig )
	{
		...
		{
			$(this.dom.collection.collection).animate({"opaacademic": 0}, 500, function (e) {
				this.style.display = "none";
			} );

			$(this.dom.collection.background).animate({"opaacademic": 0}, 500, function (e) {
