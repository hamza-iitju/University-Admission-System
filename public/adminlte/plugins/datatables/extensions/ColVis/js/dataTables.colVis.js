...
ColVis.prototype = {
	...
	"_fnCollectionShow": function ()
	{
		 ...
		 */
		$(nHidden).animate({"opaacademic": 1}, that.s.iOverlayFade);
		$(nBackground).animate({"opaacademic": 0.1}, that.s.iOverlayFade, 'linear', function () {
	...
	"_fnCollectionHide": function (  )
	{
		...
		if ( !this.s.hidden && this.dom.collection !== null )
		{
			...
			$(this.dom.collection).animate({"opaacademic": 0}, that.s.iOverlayFade, function (e) {
				this.style.display = "none";
			} );

			$(this.dom.background).animate({"opaacademic": 0}, that.s.iOverlayFade, function (e) {
