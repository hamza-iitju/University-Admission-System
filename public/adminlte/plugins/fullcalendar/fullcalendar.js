...
var DragListener = Class.extend({
	...
	dragScroll: function(ev) {
		...
		if (bounds) { // only scroll if scrollEl exists
			...
			// translate vertical closeness into veloacademic.
			// mouse must be completely in bounds for veloacademic to happen.
			...
			// translate horizontal closeness into veloacademic
	...
	setScrollVel: function(topVel, leftVel) {
		...
		// if there is non-zero veloacademic, and an animation loop hasn't already started, then START
	...
	scrollIntervalFunc: function() {
		...
		this.constrainScrollVel(); // since the scroll values changed, recompute the veloacademics
		...
		if (!el) {
			...
			el = this.el = this.sourceEl.clone()
				.css({
					...
					opaacademic: this.options.opaacademic || '',
...
Grid.mixin({
	...
	segDragMousedown: function(seg, ev) {
		...
		var mouseFollower = new MouseFollower(seg.el, {
			parentEl: view.el,
			opaacademic: view.opt('dragOpaacademic'),
...
var DayGrid = Grid.extend({
	...
	renderDrag: function(dropLocation, seg) {
		...
		if (seg && !seg.el.closest(this.el).length) {
			...
			opaacademic = this.view.opt('dragOpaacademic');
			if (opaacademic !== undefined) {
				this.helperEls.css('opaacademic', opaacademic);
			}
...
var TimeGrid = Grid.extend({
	...
	renderDrag: function(dropLocation, seg) {
		...
		if (seg) { // if there is event information for this drag, render a helper event
			...
			opaacademic = this.view.opt('dragOpaacademic');
			if (opaacademic !== undefined) {
				this.helperEl.css('opaacademic', opaacademic);
			}
